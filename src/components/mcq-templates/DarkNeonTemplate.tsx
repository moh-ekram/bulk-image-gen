...
export const DarkNeonTemplate: React.FC<Props> = ({ mcq, config }) => {
  ...
  return (
    ...
    >
      ...
      {/* Main Card */}
      <div className="z-10 w-full max-w-[480px] my-auto bg-black/90 border border-slate-700/80 rounded-2xl p-7 shadow-[0_0_30px_rgba(56,189,248,0.2)] flex flex-col justify-between min-h-[400px]">
        {/* Header Badge */}
            ...
            return (
              ...
              >
                <span className={`w-8 h-8 rounded-lg flex items-center justify-center font-bold text-sm shrink-0 ${
                  isCorrect ? 'bg-emerald-500 text-white' : 'bg-cyan-500/20 text-cyan-300 border border-cyan-500/40'
                }`}>
                  {opt.label}
                </span>
