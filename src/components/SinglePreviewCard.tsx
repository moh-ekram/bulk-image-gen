...
export const SinglePreviewCard: React.FC<Props> = ({
  ...
  return (
    <div className="w-full bg-slate-900 border border-slate-800 rounded-lg p-6 shadow-xs text-slate-100 flex flex-col items-center justify-between">
      {/* Header Bar */}
      <div className="w-full flex items-center justify-between pb-4 border-b border-slate-800 mb-4">
        ...
        <div className="flex items-center gap-1.5">
          <button
            ...
            className="p-1.5 bg-slate-950 border border-slate-800 rounded hover:bg-slate-800 disabled:opacity-30 disabled:cursor-not-allowed text-slate-200 cursor-pointer"
          >
            <ChevronLeft className="w-4 h-4" />
          </button>
          <span className="text-xs font-mono font-bold text-indigo-400 px-2">
      ...
      <div className="w-full flex items-center justify-center p-4 bg-slate-800/70 rounded-lg border border-slate-800 my-auto min-h-[380px] overflow-auto shadow-inner">
      ...
      <div className="w-full pt-4 mt-4 border-t border-slate-800 flex flex-col sm:flex-row items-center justify-between gap-3">
        ...
        <div className="flex flex-wrap items-center gap-2 w-full sm:w-auto">
          ...
          <button
            ...
            className="flex-1 sm:flex-none px-3 py-2 bg-slate-800 hover:bg-slate-700 rounded text-xs font-semibold text-slate-200 flex items-center justify-center gap-1.5 cursor-pointer transition-colors"
          >
            {copiedMsg ? (
              <>
